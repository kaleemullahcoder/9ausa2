...
function SignInForm() {
  ...
  // Redirect if already logged in (only once, with guard to prevent loops)
  useEffect(() => {
    if (user && !isLoading && !hasRedirected) {
      const redirect = searchParams.get('redirect') || '/dashboard';
      console.log('User authenticated, preparing redirect to:', redirect);
      setHasRedirected(true);

      // Use router.push - it's the proper Next.js way and won't cause reload loops
      router.push(redirect);
    }
  }, [user, isLoading, hasRedirected, router, searchParams]);
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-dark-border bg-dark-hover text-blue-primary focus:ring-2 focus:ring-blue-primary/20"
                />
                <span className="text-sm text-blue-accent/70">Remember me</span>
              </label>
              <Link
                href="#"
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-dark-card text-blue-accent/70">
                Or continue with
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              type="button"
              className="flex items-center justify-center gap-2 px-4 py-3 rounded-lg border border-dark-border bg-dark-hover text-blue-accent hover:border-blue-primary hover:bg-dark-card transition-all"
            >
